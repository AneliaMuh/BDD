...
public class MoneyTransferTest {
    ...
    void shouldTransferFromFirstToSecond() {
        ...
        dashboardPage = transferPage.makeValideTransfer(String.valueOf(amount), firstCardInfo);
    ...
    void shouldGetErrorMessageIfAmountMoreBalance() {
        ...
        transferPage.findErrorMessage("Выполнена попытка перевода суммы, превышающей на карте списания");
        dashboardPage.reloadDashboardPage();
        var actualBalanceFirstCard = dashboardPage.getCardBalance(getMaskedNumber(firstCardInfo.getCardNumber()));;
        var actualBalanceSecondCard = dashboardPage.getCardBalance(1);
